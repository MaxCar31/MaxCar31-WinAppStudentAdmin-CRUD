namespace WinAppStudentAdmin
{
    partial class FormMostarLista
    {
        ...
        private void InitializeComponent()
        {
            ...
            // BotonRegresar
            // 
            BotonRegresar.Location = new Point(516, 438);
            ...
            ClientSize = new Size(612, 480);
            Controls.Add(BotonRegresar);
            Controls.Add(dataGridView1);
            Name = "FormMostarLista";
            Text = "FormReadStudent";
            Load += FormReadStudent_Load;
